...
#define ITEM_GARBINITE 632
#define ITEM_DREDNITE 633
#define ITEM_ORBEETITE 634
...
#define FIRST_BERRY_MASTER_BERRY      ITEM_CORNN_BERRY
#define LAST_BERRY_MASTER_BERRY       LAST_BERRY_INDEX
#define FIRST_BERRY_MASTER_WIFE_BERRY ITEM_LUM_BERRY
#define LAST_BERRY_MASTER_WIFE_BERRY  ITEM_ROSELI_BERRY
#define FIRST_KIRI_BERRY              ITEM_POMEG_BERRY
#define LAST_KIRI_BERRY               LAST_BERRY_INDEX
#define FIRST_ROUTE_114_MAN_BERRY     ITEM_RAZZ_BERRY
#define LAST_ROUTE_114_MAN_BERRY      LAST_BERRY_INDEX
