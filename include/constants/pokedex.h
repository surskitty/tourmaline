...
enum {
    HOENN_DEX_NONE,
    HOENN_DEX_TREECKO, HOENN_DEX_GROVYLE, HOENN_DEX_SCEPTILE,
    HOENN_DEX_TORCHIC, HOENN_DEX_COMBUSKEN, HOENN_DEX_BLAZIKEN,
    HOENN_DEX_MUDKIP,  HOENN_DEX_MARSHTOMP, HOENN_DEX_SWAMPERT,
    HOENN_DEX_EEVEE,
                    HOENN_DEX_VAPOREON, HOENN_DEX_JOLTEON, HOENN_DEX_FLAREON,
                    HOENN_DEX_ESPEON, HOENN_DEX_UMBREON,
                    HOENN_DEX_LEAFEON, HOENN_DEX_GLACEON,
                    HOENN_DEX_SYLVEON,
    HOENN_DEX_POOCHYENA, HOENN_DEX_MIGHTYENA,
    HOENN_DEX_ZIGZAGOON, HOENN_DEX_LINOONE, HOENN_DEX_OBSTAGOON,
    HOENN_DEX_LILLIPUP,  HOENN_DEX_HERDIER, HOENN_DEX_STOUTLAND,
    HOENN_DEX_WURMPLE, HOENN_DEX_SILCOON, HOENN_DEX_BEAUTIFLY,
                       HOENN_DEX_CASCOON, HOENN_DEX_DUSTOX,
    HOENN_DEX_SEWADDLE, HOENN_DEX_SWADLOON, HOENN_DEX_LEAVANNY,
    HOENN_DEX_BLIPBUG,  HOENN_DEX_DOTTLER, HOENN_DEX_ORBEETLE,
    HOENN_DEX_TAROUNTULA, HOENN_DEX_SPIDOPS,
    HOENN_DEX_ZORUA, HOENN_DEX_ZOROARK,
    HOENN_DEX_LOTAD, HOENN_DEX_LOMBRE, HOENN_DEX_LUDICOLO,
    HOENN_DEX_SEEDOT, HOENN_DEX_NUZLEAF, HOENN_DEX_SHIFTRY,
    HOENN_DEX_AZURILL, HOENN_DEX_MARILL, HOENN_DEX_AZUMARILL,
    HOENN_DEX_TYMPOLE, HOENN_DEX_PALPITOAD, HOENN_DEX_SEISMITOAD,
    HOENN_DEX_GOTHITA, HOENN_DEX_GOTHORITA, HOENN_DEX_GOTHITELLE,
    HOENN_DEX_RALTS, HOENN_DEX_KIRLIA, HOENN_DEX_GARDEVOIR, HOENN_DEX_GALLADE,
    HOENN_DEX_SURSKIT, HOENN_DEX_MASQUERAIN,
    HOENN_DEX_WINGULL, HOENN_DEX_PELIPPER,
    HOENN_DEX_CHEWTLE, HOENN_DEX_DREDNAW,
    HOENN_DEX_SHELLOS, HOENN_DEX_GASTRODON,
    HOENN_DEX_SHUCKLE,
    HOENN_DEX_TAILLOW, HOENN_DEX_SWELLOW,
    HOENN_DEX_SHROOMISH, HOENN_DEX_BRELOOM,
    HOENN_DEX_SLAKOTH, HOENN_DEX_VIGOROTH, HOENN_DEX_SLAKING,
    HOENN_DEX_MORELULL, HOENN_DEX_SHIINOTIC,
    HOENN_DEX_COTTONEE, HOENN_DEX_WHIMSICOTT,
    HOENN_DEX_PHANTUMP, HOENN_DEX_TREVENANT,
    HOENN_DEX_PIDGEY, HOENN_DEX_PIDGEOTTO, HOENN_DEX_PIDGEOT,
    HOENN_DEX_CHATOT,
    HOENN_DEX_ABRA, HOENN_DEX_KADABRA, HOENN_DEX_ALAKAZAM,
    HOENN_DEX_NINCADA, HOENN_DEX_NINJASK, HOENN_DEX_SHEDINJA,
    HOENN_DEX_WHISMUR, HOENN_DEX_LOUDRED, HOENN_DEX_EXPLOUD,
    HOENN_DEX_AUDINO,
    HOENN_DEX_SKITTY, HOENN_DEX_DELCATTY,
    HOENN_DEX_JOLTIK, HOENN_DEX_GALVANTULA,
    HOENN_DEX_STUFFUL, HOENN_DEX_BEWEAR,
    HOENN_DEX_NACLI, HOENN_DEX_NACLSTACK, HOENN_DEX_GARGANACL,
    HOENN_DEX_ROGGENROLA, HOENN_DEX_BOLDORE, HOENN_DEX_GIGALITH,
    HOENN_DEX_CLOBBOPUS, HOENN_DEX_GRAPPLOCT,
    HOENN_DEX_WIGLETT, HOENN_DEX_WUGTRIO,
    HOENN_DEX_PYUKUMUKU,
    HOENN_DEX_SANDYGAST, HOENN_DEX_PALOSSAND,
    HOENN_DEX_CRABRAWLER, HOENN_DEX_CRABOMINABLE,
    HOENN_DEX_MAKUHITA, HOENN_DEX_HARIYAMA,
    HOENN_DEX_ZUBAT, HOENN_DEX_GOLBAT, HOENN_DEX_CROBAT,
    HOENN_DEX_GOLDEEN, HOENN_DEX_SEAKING,
    HOENN_DEX_MAGIKARP, HOENN_DEX_GYARADOS,
    HOENN_DEX_TENTACOOL, HOENN_DEX_TENTACRUEL,
    HOENN_DEX_GEODUDE, HOENN_DEX_GRAVELER, HOENN_DEX_GOLEM,
    HOENN_DEX_NOSEPASS, HOENN_DEX_PROBOPASS,
    HOENN_DEX_SABLEYE, HOENN_DEX_MAWILE,
    HOENN_DEX_ARON, HOENN_DEX_LAIRON, HOENN_DEX_AGGRON,
    HOENN_DEX_AXEW, HOENN_DEX_FRAXURE, HOENN_DEX_HAXORUS,
    HOENN_DEX_PINCURCHIN,
    HOENN_DEX_ELECTRIKE, HOENN_DEX_MANECTRIC,
    HOENN_DEX_PLUSLE, HOENN_DEX_MINUN,
    HOENN_DEX_MAGNEMITE, HOENN_DEX_MAGNETON, HOENN_DEX_MAGNEZONE,
    HOENN_DEX_VOLTORB, HOENN_DEX_ELECTRODE,
    HOENN_DEX_GULPIN, HOENN_DEX_SWALOT,
    HOENN_DEX_TRUBBISH, HOENN_DEX_GARBODOR,
    HOENN_DEX_BUDEW, HOENN_DEX_ROSELIA, HOENN_DEX_ROSERADE,
    HOENN_DEX_ODDISH, HOENN_DEX_GLOOM, HOENN_DEX_VILEPLUME, HOENN_DEX_BELLOSSOM,
    HOENN_DEX_LEDYBA, HOENN_DEX_LEDIAN,
    HOENN_DEX_VOLBEAT, HOENN_DEX_ILLUMISE,
    HOENN_DEX_MIENFOO, HOENN_DEX_MIENSHAO,
    HOENN_DEX_CARVANHA, HOENN_DEX_SHARPEDO,
    HOENN_DEX_SKRELP, HOENN_DEX_DRAGALGE,
    HOENN_DEX_CLAUNCHER, HOENN_DEX_CLAWITZER,
    HOENN_DEX_BASCULIN, HOENN_DEX_BASCULEGION,
    HOENN_DEX_WAILMER, HOENN_DEX_WAILORD,
    HOENN_DEX_NUMEL, HOENN_DEX_CAMERUPT,
    HOENN_DEX_FIDOUGH, HOENN_DEX_DACHSBUN,
    HOENN_DEX_SLUGMA, HOENN_DEX_MAGCARGO,
    HOENN_DEX_TORKOAL,
    HOENN_DEX_KOFFING, HOENN_DEX_WEEZING,
    HOENN_DEX_SALANDIT, HOENN_DEX_SALAZZLE,
    HOENN_DEX_DIGLETT, HOENN_DEX_DUGTRIO,
    HOENN_DEX_SPOINK, HOENN_DEX_GRUMPIG,
    HOENN_DEX_MANKEY, HOENN_DEX_PRIMEAPE, HOENN_DEX_ANNIHILAPE,
    HOENN_DEX_TYROGUE, HOENN_DEX_HITMONLEE, HOENN_DEX_HITMONCHAN, HOENN_DEX_HITMONTOP,
    HOENN_DEX_TINKATINK, HOENN_DEX_TINKATUFF, HOENN_DEX_TINKATON,
    HOENN_DEX_CHARCADET, HOENN_DEX_ARMAROUGE, HOENN_DEX_CERULEDGE,
    HOENN_DEX_SANDSHREW, HOENN_DEX_SANDSLASH,
    HOENN_DEX_SPINDA,
    HOENN_DEX_SKARMORY,
    HOENN_DEX_TRAPINCH, HOENN_DEX_VIBRAVA, HOENN_DEX_FLYGON,
    HOENN_DEX_CACNEA, HOENN_DEX_CACTURNE,
    HOENN_DEX_SANDILE, HOENN_DEX_KROKOROK, HOENN_DEX_KROOKODILE,
    HOENN_DEX_DWEBBLE, HOENN_DEX_CRUSTLE,
    HOENN_DEX_SWABLU, HOENN_DEX_ALTARIA,
    HOENN_DEX_ZANGOOSE, HOENN_DEX_SEVIPER,
    HOENN_DEX_LUNATONE, HOENN_DEX_SOLROCK,
    HOENN_DEX_MINIOR,
    HOENN_DEX_BAGON, HOENN_DEX_SHELGON, HOENN_DEX_SALAMENCE,
    HOENN_DEX_BARBOACH, HOENN_DEX_WHISCASH,
    HOENN_DEX_CORPHISH, HOENN_DEX_CRAWDAUNT,
    HOENN_DEX_BALTOY, HOENN_DEX_CLAYDOL,
    HOENN_DEX_LILEEP, HOENN_DEX_CRADILY,
    HOENN_DEX_ANORITH, HOENN_DEX_ARMALDO,
    HOENN_DEX_FRILLISH, HOENN_DEX_JELLICENT,
    HOENN_DEX_DHELMISE,
    HOENN_DEX_BINACLE, HOENN_DEX_BARBARACLE,
    HOENN_DEX_PICHU, HOENN_DEX_PIKACHU, HOENN_DEX_RAICHU,
    HOENN_DEX_ROTOM,
    HOENN_DEX_IGGLYBUFF, HOENN_DEX_JIGGLYPUFF, HOENN_DEX_WIGGLYTUFF,
    HOENN_DEX_SHROODLE, HOENN_DEX_GRAFAIAI,
    HOENN_DEX_KECLEON,
    HOENN_DEX_EXEGGCUTE, HOENN_DEX_EXEGGUTOR,
    HOENN_DEX_FEEBAS, HOENN_DEX_MILOTIC,
    HOENN_DEX_TROPIUS,
    HOENN_DEX_CASTFORM,
    HOENN_DEX_STARYU, HOENN_DEX_STARMIE,
    HOENN_DEX_SHUPPET, HOENN_DEX_BANETTE,
    HOENN_DEX_DUSKULL, HOENN_DEX_DUSCLOPS, HOENN_DEX_DUSKNOIR,
    HOENN_DEX_CHINGLING, HOENN_DEX_CHIMECHO,
    HOENN_DEX_ABSOL,
    HOENN_DEX_VULPIX, HOENN_DEX_NINETALES,
    HOENN_DEX_MEDITITE, HOENN_DEX_MEDICHAM,
    HOENN_DEX_PSYDUCK, HOENN_DEX_GOLDUCK,
    HOENN_DEX_WYNAUT, HOENN_DEX_WOBBUFFET,
    HOENN_DEX_NATU, HOENN_DEX_XATU,
    HOENN_DEX_GIRAFARIG, HOENN_DEX_FARIGIRAF,
    HOENN_DEX_BUNEARY, HOENN_DEX_LOPUNNY,
    HOENN_DEX_VENONAT, HOENN_DEX_VENOMOTH,
    HOENN_DEX_PINSIR, HOENN_DEX_HERACROSS,
    HOENN_DEX_MAREEP, HOENN_DEX_FLAAFFY, HOENN_DEX_AMPHAROS,
    HOENN_DEX_TEDDIURSA, HOENN_DEX_URSARING, HOENN_DEX_URSALUNA,
    HOENN_DEX_HOUNDOUR, HOENN_DEX_HOUNDOOM,
    HOENN_DEX_STANTLER, HOENN_DEX_WYRDEER,
    HOENN_DEX_SMEARGLE,
    HOENN_DEX_WATTREL, HOENN_DEX_KILOWATTREL,
    HOENN_DEX_SPHEAL, HOENN_DEX_SEALEO, HOENN_DEX_WALREIN,
    HOENN_DEX_CETODDLE, HOENN_DEX_CETITAN,
    HOENN_DEX_SNORUNT, HOENN_DEX_GLALIE, HOENN_DEX_FROSLASS,
    HOENN_DEX_FRIGIBAX, HOENN_DEX_ARCTIBAX, HOENN_DEX_BAXCALIBUR,
    HOENN_DEX_CLAMPERL, HOENN_DEX_HUNTAIL, HOENN_DEX_GOREBYSS,
    HOENN_DEX_RELICANTH,
    HOENN_DEX_CORSOLA, HOENN_DEX_CURSOLA,
    HOENN_DEX_CHINCHOU, HOENN_DEX_LANTURN,
    HOENN_DEX_LUVDISC,
    HOENN_DEX_TATSUGIRI, HOENN_DEX_DONDOZO,
    HOENN_DEX_HORSEA, HOENN_DEX_SEADRA, HOENN_DEX_KINGDRA,
    HOENN_DEX_BELDUM, HOENN_DEX_METANG, HOENN_DEX_METAGROSS,
    HOENN_DEX_REGIROCK, HOENN_DEX_REGICE, HOENN_DEX_REGISTEEL,
    HOENN_DEX_LATIAS, HOENN_DEX_LATIOS,
    HOENN_DEX_KYOGRE, HOENN_DEX_GROUDON,
    HOENN_DEX_RAYQUAZA,
    HOENN_DEX_REGIELEKI, HOENN_DEX_REGIDRAGO, HOENN_DEX_REGIGIGAS,
    HOENN_DEX_JIRACHI,
    HOENN_DEX_DEOXYS,
};
