...
static bool32 ShouldSwitchIfWonderGuard(u32 battler, bool32 emitResult)
{
    ...
    if (!AI_BATTLER_HAS_TRAIT(GetBattlerAtPosition(opposingPosition), ABILITY_WONDER_GUARD))
        return FALSE;
...
static bool32 ShouldSwitchIfAbilityBenefit(u32 battler, bool32 emitResult)
{
    ...
    else if (AI_BATTLER_HAS_TRAIT(battler, ABILITY_REGENERATOR))
    {
        moduloChance = 2; //50%
...
static bool32 IsMonGrounded(u16 heldItemEffect, u32 ability, u8 type1, u8 type2, u16 species, u32 personality)
{
