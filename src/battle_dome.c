...
static int GetTypeEffectivenessPoints(int move, int targetSpecies, int mode)
{
    ...
    if (GetBattlerTrait(gBattlerTarget, ABILITY_LEVITATE) && moveType == TYPE_GROUND)
    {
    ...
    else
    {
        ...
        if (GetBattlerTrait(gBattlerTarget, ABILITY_WONDER_GUARD) && typeEffectiveness1 != TYPE_x1 && typeEffectiveness2 != TYPE_x1)
            typePower = 0;
    }
