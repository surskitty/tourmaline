...
static u8 CreateNPCTrainerParty(struct Pokemon *party, u16 trainerNum, bool8 firstTrainer)
{
                                                                        ...
                                                                        | BATTLE_TYPE_TRAINER_HILL)))
    {
        ...
        for (i = 0; i < monsCount; i++)
        {
            ...
            {
                const struct TrainerMonNoItemDefaultMovesCustomAbility *partyData = gTrainers[trainerNum].party.NoItemDefaultMovesCustomAbility;
            ...
            {
                const struct TrainerMonNoItemCustomMovesCustomAbility *partyData = gTrainers[trainerNum].party.NoItemCustomMovesCustomAbility;
            ...
            {
                const struct TrainerMonItemDefaultMovesCustomAbility *partyData = gTrainers[trainerNum].party.ItemDefaultMovesCustomAbility;
