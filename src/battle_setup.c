...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_NORMAN] = REMATCH(TRAINER_NORMAN_1, TRAINER_NORMAN_2, TRAINER_NORMAN_2, TRAINER_NORMAN_2, TRAINER_NORMAN_2, MAP_PETALBURG_CITY),
    [REMATCH_WINONA] = REMATCH(TRAINER_WINONA_1, TRAINER_WINONA_2, TRAINER_WINONA_2, TRAINER_WINONA_2, TRAINER_WINONA_2, MAP_FORTREE_CITY),
    ...
    [REMATCH_JUAN] = REMATCH(TRAINER_JUAN_1, TRAINER_JUAN_2, TRAINER_JUAN_2, TRAINER_JUAN_2, TRAINER_JUAN_2, MAP_SOOTOPOLIS_CITY),
