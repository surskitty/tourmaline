const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_VENUSAUR]              = {{EVO_MEGA_EVOLUTION, ITEM_MEGA_STONE, SPECIES_VENUSAUR_MEGA}},
    [SPECIES_CHARMANDER]            = {{EVO_LEVEL, 16, SPECIES_CHARMELEON}},
    [SPECIES_CHARMELEON]            = {{EVO_LEVEL, 36, SPECIES_CHARIZARD}},
    [SPECIES_CHARIZARD]             = {{EVO_MEGA_EVOLUTION, ITEM_MEGA_STONE_X, SPECIES_CHARIZARD_MEGA_X},
                                       {EVO_MEGA_EVOLUTION, ITEM_MEGA_STONE_Y, SPECIES_CHARIZARD_MEGA_Y}},
    [SPECIES_SQUIRTLE]              = {{EVO_LEVEL, 16, SPECIES_WARTORTLE}},
    [SPECIES_WARTORTLE]             = {{EVO_LEVEL, 36, SPECIES_BLASTOISE}},
    [SPECIES_BLASTOISE]             = {{EVO_MEGA_EVOLUTION, ITEM_MEGA_STONE, SPECIES_BLASTOISE_MEGA}},
    ...
    [SPECIES_BEEDRILL]              = {{EVO_MEGA_EVOLUTION, ITEM_MEGA_STONE, SPECIES_BEEDRILL_MEGA}},
    [SPECIES_PIDGEY]                = {{EVO_LEVEL, 18, SPECIES_PIDGEOTTO}},
    [SPECIES_PIDGEOTTO]             = {{EVO_LEVEL, 36, SPECIES_PIDGEOT}},
    [SPECIES_PIDGEOT]               = {{EVO_MEGA_EVOLUTION, ITEM_MEGA_STONE, SPECIES_PIDGEOT_MEGA}},
    ...
    [SPECIES_GRAVELER]              = {{EVO_TRADE, 0, SPECIES_GOLEM}, 
                                       ...
                                       {EVO_MOVE, MOVE_ROCK_POLISH, SPECIES_GOLEM}},
    [SPECIES_PONYTA]                = {{EVO_LEVEL, 40, SPECIES_RAPIDASH}},
    [SPECIES_SLOWPOKE]              = {{EVO_LEVEL, 37, SPECIES_SLOWBRO},
                                       {EVO_TRADE_ITEM, ITEM_KINGS_ROCK, SPECIES_SLOWKING}, 
                                       {EVO_MOVE, MOVE_ZEN_HEADBUTT, SPECIES_SLOWKING}, 
                                       {EVO_ITEM, ITEM_WATER_STONE, SPECIES_SLOWKING}},
    [SPECIES_SLOWBRO]               = {{EVO_MEGA_EVOLUTION, ITEM_MEGA_STONE, SPECIES_SLOWBRO_MEGA}},
    ...
    [SPECIES_HAUNTER]               = {{EVO_TRADE, 0, SPECIES_GENGAR}, 
                                       ...
                                       {EVO_MOVE, MOVE_SUCKER_PUNCH, SPECIES_GENGAR}},
    [SPECIES_GENGAR]                = {{EVO_MEGA_EVOLUTION, ITEM_MEGA_STONE, SPECIES_GENGAR_MEGA}},
    [SPECIES_ONIX]                  = {{EVO_TRADE_ITEM, ITEM_METAL_COAT, SPECIES_STEELIX}, 
                                       {EVO_MOVE, MOVE_IRON_TAIL, SPECIES_STEELIX}},
    ...
    [SPECIES_SCYTHER]               = {{EVO_TRADE_ITEM, ITEM_METAL_COAT, SPECIES_SCIZOR}, 
                                       {EVO_MOVE, MOVE_X_SCISSOR, SPECIES_SCIZOR}},
    [SPECIES_ELECTABUZZ]            = {{EVO_TRADE_ITEM, ITEM_ELECTIRIZER, SPECIES_ELECTIVIRE}, 
                                       {EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_ELECTIVIRE}},
    [SPECIES_MAGMAR]                = {{EVO_TRADE_ITEM, ITEM_MAGMARIZER, SPECIES_MAGMORTAR}, 
                                       {EVO_ITEM, ITEM_FIRE_STONE, SPECIES_MAGMORTAR}},
    [SPECIES_PINSIR]                = {{EVO_MEGA_EVOLUTION, ITEM_MEGA_STONE, SPECIES_PINSIR_MEGA}},
    [SPECIES_MAGIKARP]              = {{EVO_LEVEL, 20, SPECIES_GYARADOS}},
    [SPECIES_GYARADOS]              = {{EVO_MEGA_EVOLUTION, ITEM_MEGA_STONE, SPECIES_GYARADOS_MEGA}},
    ...
    [SPECIES_AERODACTYL]            = {{EVO_MEGA_EVOLUTION, ITEM_MEGA_STONE, SPECIES_AERODACTYL_MEGA}},
    [SPECIES_DRATINI]               = {{EVO_LEVEL, 30, SPECIES_DRAGONAIR}},
    [SPECIES_DRAGONAIR]             = {{EVO_LEVEL, 55, SPECIES_DRAGONITE}},
    [SPECIES_MEWTWO]                = {{EVO_MEGA_EVOLUTION, ITEM_MEGA_STONE_X, SPECIES_MEWTWO_MEGA_X},
                                       {EVO_MEGA_EVOLUTION, ITEM_MEGA_STONE_Y, SPECIES_MEWTWO_MEGA_Y}},
    ...
    [SPECIES_AMPHAROS]              = {{EVO_MEGA_EVOLUTION, ITEM_MEGA_STONE, SPECIES_AMPHAROS_MEGA}},
    ...
    [SPECIES_STEELIX]               = {{EVO_MEGA_EVOLUTION, ITEM_MEGA_STONE, SPECIES_STEELIX_MEGA}},
    [SPECIES_SNUBBULL]              = {{EVO_LEVEL, 23, SPECIES_GRANBULL}},
    [SPECIES_SCIZOR]                = {{EVO_MEGA_EVOLUTION, ITEM_MEGA_STONE, SPECIES_SCIZOR_MEGA}},
    [SPECIES_HERACROSS]             = {{EVO_MEGA_EVOLUTION, ITEM_MEGA_STONE, SPECIES_HERACROSS_MEGA}},
    ...
    [SPECIES_HOUNDOOM]              = {{EVO_MEGA_EVOLUTION, ITEM_MEGA_STONE, SPECIES_HOUNDOOM_MEGA}},
    ...
    [SPECIES_TYRANITAR]             = {{EVO_MEGA_EVOLUTION, ITEM_MEGA_STONE, SPECIES_TYRANITAR_MEGA}},
    [SPECIES_TREECKO]               = {{EVO_LEVEL, 16, SPECIES_GROVYLE}},
    [SPECIES_GROVYLE]               = {{EVO_LEVEL, 36, SPECIES_SCEPTILE}},
    [SPECIES_SCEPTILE]              = {{EVO_MEGA_EVOLUTION, ITEM_MEGA_STONE, SPECIES_SCEPTILE_MEGA}},
    [SPECIES_TORCHIC]               = {{EVO_LEVEL, 16, SPECIES_COMBUSKEN}},
    [SPECIES_COMBUSKEN]             = {{EVO_LEVEL, 36, SPECIES_BLAZIKEN}},
    [SPECIES_BLAZIKEN]              = {{EVO_MEGA_EVOLUTION, ITEM_MEGA_STONE, SPECIES_BLAZIKEN_MEGA}},
    [SPECIES_MUDKIP]                = {{EVO_LEVEL, 16, SPECIES_MARSHTOMP}},
    [SPECIES_MARSHTOMP]             = {{EVO_LEVEL, 36, SPECIES_SWAMPERT}},
    [SPECIES_SWAMPERT]              = {{EVO_MEGA_EVOLUTION, ITEM_MEGA_STONE, SPECIES_SWAMPERT_MEGA}},
    ...
    [SPECIES_SABLEYE]               = {{EVO_MEGA_EVOLUTION, ITEM_MEGA_STONE, SPECIES_SABLEYE_MEGA}},
    ...
    [SPECIES_SHARPEDO]              = {{EVO_MEGA_EVOLUTION, ITEM_MEGA_STONE, SPECIES_SHARPEDO_MEGA}},
    ...
    [SPECIES_MANECTRIC]             = {{EVO_MEGA_EVOLUTION, ITEM_MEGA_STONE, SPECIES_MANECTRIC_MEGA}},
    [SPECIES_NUMEL]                 = {{EVO_LEVEL, 33, SPECIES_CAMERUPT}},
    [SPECIES_CAMERUPT]              = {{EVO_MEGA_EVOLUTION, ITEM_MEGA_STONE, SPECIES_CAMERUPT_MEGA}},
    ...
    [SPECIES_GLALIE]                = {{EVO_MEGA_EVOLUTION, ITEM_MEGA_STONE, SPECIES_GLALIE_MEGA}},
    [SPECIES_AZURILL]               = {{EVO_FRIENDSHIP, 0, SPECIES_MARILL}},
    [SPECIES_SPOINK]                = {{EVO_LEVEL, 32, SPECIES_GRUMPIG}},
    [SPECIES_MAWILE]                = {{EVO_MEGA_EVOLUTION, ITEM_MEGA_STONE, SPECIES_MAWILE_MEGA}},
    [SPECIES_MEDITITE]              = {{EVO_LEVEL, 37, SPECIES_MEDICHAM}},
    [SPECIES_MEDICHAM]              = {{EVO_MEGA_EVOLUTION, ITEM_MEGA_STONE, SPECIES_MEDICHAM_MEGA}},
    [SPECIES_SWABLU]                = {{EVO_LEVEL, 35, SPECIES_ALTARIA}},
    [SPECIES_ALTARIA]               = {{EVO_MEGA_EVOLUTION, ITEM_MEGA_STONE, SPECIES_ALTARIA_MEGA}},
    ...
    [SPECIES_CLAMPERL]              = {{EVO_TRADE_ITEM, ITEM_DEEP_SEA_TOOTH, SPECIES_HUNTAIL},
                                       ...
                                       {EVO_ITEM, ITEM_DUSK_STONE, SPECIES_HUNTAIL}},
    [SPECIES_ABSOL]                 = {{EVO_MEGA_EVOLUTION, ITEM_MEGA_STONE, SPECIES_ABSOL_MEGA}},
    [SPECIES_SHUPPET]               = {{EVO_LEVEL, 37, SPECIES_BANETTE}},
    [SPECIES_BANETTE]               = {{EVO_MEGA_EVOLUTION, ITEM_MEGA_STONE, SPECIES_BANETTE_MEGA}},
    [SPECIES_ARON]                  = {{EVO_LEVEL, 32, SPECIES_LAIRON}},
    [SPECIES_LAIRON]                = {{EVO_LEVEL, 42, SPECIES_AGGRON}},
    [SPECIES_AGGRON]                = {{EVO_MEGA_EVOLUTION, ITEM_MEGA_STONE, SPECIES_AGGRON_MEGA}},
    ...
    [SPECIES_GARDEVOIR]             = {{EVO_MEGA_EVOLUTION, ITEM_MEGA_STONE, SPECIES_GARDEVOIR_MEGA}},
    [SPECIES_BAGON]                 = {{EVO_LEVEL, 30, SPECIES_SHELGON}},
    [SPECIES_SHELGON]               = {{EVO_LEVEL, 50, SPECIES_SALAMENCE}},
    [SPECIES_SALAMENCE]             = {{EVO_MEGA_EVOLUTION, ITEM_MEGA_STONE, SPECIES_SALAMENCE_MEGA}},
    [SPECIES_BELDUM]                = {{EVO_LEVEL, 20, SPECIES_METANG}},
    [SPECIES_METANG]                = {{EVO_LEVEL, 45, SPECIES_METAGROSS}},
    [SPECIES_METAGROSS]             = {{EVO_MEGA_EVOLUTION, ITEM_MEGA_STONE, SPECIES_METAGROSS_MEGA}},
    [SPECIES_LATIAS]                = {{EVO_MEGA_EVOLUTION, ITEM_MEGA_STONE, SPECIES_LATIAS_MEGA}},
    [SPECIES_LATIOS]                = {{EVO_MEGA_EVOLUTION, ITEM_MEGA_STONE, SPECIES_LATIOS_MEGA}},
    ...
    [SPECIES_LOPUNNY]               = {{EVO_MEGA_EVOLUTION, ITEM_MEGA_STONE, SPECIES_LOPUNNY_MEGA}},
    ...
    [SPECIES_HAPPINY]               = {{EVO_MOVE, MOVE_REFRESH, SPECIES_CHANSEY}},
    [SPECIES_GIBLE]                 = {{EVO_LEVEL, 24, SPECIES_GABITE}},
    [SPECIES_GABITE]                = {{EVO_LEVEL, 48, SPECIES_GARCHOMP}},
    [SPECIES_GARCHOMP]              = {{EVO_MEGA_EVOLUTION, ITEM_MEGA_STONE, SPECIES_GARCHOMP_MEGA}},
    [SPECIES_MUNCHLAX]              = {{EVO_FRIENDSHIP, 0, SPECIES_SNORLAX}},
    [SPECIES_RIOLU]                 = {{EVO_FRIENDSHIP, 0, SPECIES_LUCARIO}},
    [SPECIES_LUCARIO]               = {{EVO_MEGA_EVOLUTION, ITEM_MEGA_STONE, SPECIES_LUCARIO_MEGA}},
    ...
    [SPECIES_ABOMASNOW]             = {{EVO_MEGA_EVOLUTION, ITEM_MEGA_STONE, SPECIES_ABOMASNOW_MEGA}},
    [SPECIES_GALLADE]               = {{EVO_MEGA_EVOLUTION, ITEM_MEGA_STONE, SPECIES_GALLADE_MEGA}},
    ...
    [SPECIES_BOLDORE]               = {{EVO_TRADE, 0, SPECIES_GIGALITH},
                                       {EVO_MOVE, MOVE_SANDSTORM, SPECIES_GIGALITH},
    ...
    [SPECIES_AUDINO]                = {{EVO_MEGA_EVOLUTION, ITEM_MEGA_STONE, SPECIES_AUDINO_MEGA}},
    [SPECIES_TIMBURR]               = {{EVO_LEVEL, 25, SPECIES_GURDURR}},
    [SPECIES_GURDURR]               = {{EVO_TRADE, 0, SPECIES_CONKELDURR},
                                       {EVO_MOVE, MOVE_STRENGTH, SPECIES_GIGALITH},
    ...
    [SPECIES_VANILLISH]             = {{EVO_LEVEL, 44, SPECIES_VANILLUXE}},
    ...
    [SPECIES_PHANTUMP]              = {{EVO_TRADE, 0, SPECIES_TREVENANT},
                                       {EVO_ITEM, ITEM_DUSK_STONE, SPECIES_TREVENANT}},
    ...
    [SPECIES_NOIBAT]                = {{EVO_LEVEL, 36, SPECIES_NOIVERN}},
    [SPECIES_DIANCIE]               = {{EVO_MEGA_EVOLUTION, ITEM_MEGA_STONE, SPECIES_DIANCIE_MEGA}},
    ...
    [SPECIES_APPLIN]                = {{EVO_ITEM, ITEM_SHINY_STONE, SPECIES_FLAPPLE},
