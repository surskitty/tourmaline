const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_SHELMET]     = {{EVO_ITEM, ITEM_KINGS_ROCK, SPECIES_ACCELGOR}},
    ...
    [SPECIES_SLIGGOO]     = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_GOODRA}},
    [SPECIES_PHANTUMP]    = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_TREVENANT}},
    [SPECIES_PUMPKABOO]   = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_GOURGEIST}},
    ...
    [SPECIES_ALOLAN_GRAVELER]    = {{EVO_LEVEL, 37, SPECIES_ALOLAN_GOLEM}},
