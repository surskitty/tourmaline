...
{
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM, SPECIES_GARBODOR_MEGA, ITEM_GARBINITE},
    {FORM_CHANGE_TERMINATOR},
};
...
{
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM, SPECIES_ORBEETLE_MEGA, ITEM_ORBEETITE},
    {FORM_CHANGE_TERMINATOR},
};
