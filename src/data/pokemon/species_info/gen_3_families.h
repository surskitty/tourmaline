...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_POOCHYENA] =
    {
        ...
        .abilities = { ABILITY_DEFIANT, ABILITY_NONE, ABILITY_SPEED_BOOST },//ABILITY_RUN_AWAY
    #else
    ...
    [SPECIES_ZIGZAGOON] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_EARLY_BIRD, ABILITY_GLUTTONY, ABILITY_QUICK_FEET },
    #else
    ...
    [SPECIES_TAILLOW] =
    {
        ...
        .abilities = { ABILITY_TRACE, ABILITY_NONE, ABILITY_SCRAPPY },
        .bodyColor = BODY_COLOR_BLUE,
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_KIRLIA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = RALTS_FAMILY_EGG_GROUPS,
        .abilities = { ABILITY_SYNCHRONIZE, ABILITY_FLOWER_GIFT, ABILITY_TELEPATHY },
        .bodyColor = BODY_COLOR_WHITE,
