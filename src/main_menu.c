...
static void Task_NewGameBirchSpeechSub_InitPokeBall(u8 taskId)
{
    ...
    CreatePokeballSpriteToReleaseMon(spriteId, gSprites[spriteId].oam.paletteNum, 112, 58, 0, 0, 32, 0x0000FFFF, SPECIES_VENONAT);
...
static u8 NewGameBirchSpeech_CreateVenonatSprite(u8 a, u8 b)
{
    return CreatePicSprite2(SPECIES_VENONAT, SHINY_ODDS, 0, 1, a, b, 14, -1);
}
