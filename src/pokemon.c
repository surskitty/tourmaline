...
static const u16 sHoennToNationalOrder[HOENN_DEX_COUNT - 1] =
{
    ...
    HOENN_TO_NATIONAL(EEVEE), HOENN_TO_NATIONAL(SYLVEON),
    HOENN_TO_NATIONAL(VAPOREON), HOENN_TO_NATIONAL(JOLTEON), HOENN_TO_NATIONAL(FLAREON),
    HOENN_TO_NATIONAL(ESPEON), HOENN_TO_NATIONAL(UMBREON),
    HOENN_TO_NATIONAL(LEAFEON), HOENN_TO_NATIONAL(GLACEON),

    HOENN_TO_NATIONAL(POOCHYENA), HOENN_TO_NATIONAL(MIGHTYENA),
    HOENN_TO_NATIONAL(ZIGZAGOON), HOENN_TO_NATIONAL(LINOONE),
    ...
    HOENN_TO_NATIONAL(RALTS), HOENN_TO_NATIONAL(KIRLIA), HOENN_TO_NATIONAL(GARDEVOIR), HOENN_TO_NATIONAL(GALLADE),
    ...
    HOENN_TO_NATIONAL(NINCADA), HOENN_TO_NATIONAL(NINJASK), HOENN_TO_NATIONAL(SHEDINJA),
    ...
    HOENN_TO_NATIONAL(SABLEYE), HOENN_TO_NATIONAL(MAWILE),
    ...
    HOENN_TO_NATIONAL(PLUSLE), HOENN_TO_NATIONAL(MINUN),
    HOENN_TO_NATIONAL(VOLBEAT), HOENN_TO_NATIONAL(ILLUMISE),
    ...
    HOENN_TO_NATIONAL(ZANGOOSE), HOENN_TO_NATIONAL(SEVIPER),
    HOENN_TO_NATIONAL(LUNATONE), HOENN_TO_NATIONAL(SOLROCK),
    HOENN_TO_NATIONAL(BARBOACH), HOENN_TO_NATIONAL(WHISCASH),
    HOENN_TO_NATIONAL(CORPHISH), HOENN_TO_NATIONAL(CRAWDAUNT),
    ...
    HOENN_TO_NATIONAL(SNORUNT), HOENN_TO_NATIONAL(GLALIE), HOENN_TO_NATIONAL(FROSLASS),
    HOENN_TO_NATIONAL(SPHEAL), HOENN_TO_NATIONAL(SEALEO), HOENN_TO_NATIONAL(WALREIN),
    HOENN_TO_NATIONAL(CLAMPERL), HOENN_TO_NATIONAL(HUNTAIL), HOENN_TO_NATIONAL(GOREBYSS),
    ...
    HOENN_TO_NATIONAL(REGIELEKI), HOENN_TO_NATIONAL(REGIDRAGO), HOENN_TO_NATIONAL(REGIGIGAS),
    HOENN_TO_NATIONAL(LATIAS), HOENN_TO_NATIONAL(LATIOS),
    HOENN_TO_NATIONAL(KYOGRE), HOENN_TO_NATIONAL(GROUDON), HOENN_TO_NATIONAL(RAYQUAZA),
    ...
    HOENN_TO_NATIONAL(TYROGUE), HOENN_TO_NATIONAL(HITMONLEE), HOENN_TO_NATIONAL(HITMONCHAN),
    ...
    HOENN_TO_NATIONAL(ODDISH), HOENN_TO_NATIONAL(GLOOM), HOENN_TO_NATIONAL(VILEPLUME), HOENN_TO_NATIONAL(BELLOSSOM),
    ...
    HOENN_TO_NATIONAL(BASCULIN), HOENN_TO_NATIONAL(BASCULEGION),
    HOENN_TO_NATIONAL(TRUBBISH), HOENN_TO_NATIONAL(GARBODOR),
    HOENN_TO_NATIONAL(MIENFOO), HOENN_TO_NATIONAL(MIENSHAO),
    HOENN_TO_NATIONAL(AXEW), HOENN_TO_NATIONAL(FRAXURE), HOENN_TO_NATIONAL(HAXORUS),
    HOENN_TO_NATIONAL(DWEBBLE), HOENN_TO_NATIONAL(CRUSTLE),

    HOENN_TO_NATIONAL(PHANTUMP), HOENN_TO_NATIONAL(TREVENANT),
    HOENN_TO_NATIONAL(SKRELP), HOENN_TO_NATIONAL(DRAGALGE),
    HOENN_TO_NATIONAL(CLAUNCHER), HOENN_TO_NATIONAL(CLAWITZER),
    ...
    HOENN_TO_NATIONAL(CRABRAWLER), HOENN_TO_NATIONAL(CRABOMINABLE),
    HOENN_TO_NATIONAL(MINIOR),
    HOENN_TO_NATIONAL(SANDYGAST), HOENN_TO_NATIONAL(PALOSSAND),
    HOENN_TO_NATIONAL(STUFFUL), HOENN_TO_NATIONAL(BEWEAR),
    ...
    HOENN_TO_NATIONAL(TAROUNTULA), HOENN_TO_NATIONAL(SPIDOPS),
    HOENN_TO_NATIONAL(FIDOUGH), HOENN_TO_NATIONAL(DACHSBUN),
    HOENN_TO_NATIONAL(SHROODLE), HOENN_TO_NATIONAL(GRAFAIAI),
    HOENN_TO_NATIONAL(CHARCADET), HOENN_TO_NATIONAL(ARMAROUGE), HOENN_TO_NATIONAL(CERULEDGE),
    ...
    HOENN_TO_NATIONAL(TATSUGIRI), HOENN_TO_NATIONAL(DONDOZO),
...
static const struct SpeciesItem sAlteringCaveWildMonHeldItems[] =
{
    ...
    {SPECIES_LEDYBA,    ITEM_APICOT_BERRY},
    {SPECIES_HOUNDOUR,  ITEM_BIG_MUSHROOM},
    {SPECIES_TEDDIURSA, ITEM_PETAYA_BERRY},
    {SPECIES_AIPOM,     ITEM_BERRY_JUICE},
    {SPECIES_SHROODLE,   ITEM_BERRY_JUICE},
...
u8 GetMoveRelearnerMoves(struct Pokemon *mon, u16 *moves)
{
    ...
    {
        for (i = 0; i < sizeof(eggMoveLearnset); i++)
        {
...
u8 GetNumberOfRelearnableMoves(struct Pokemon *mon)
{
    ...
    if (FlagGet(FLAG_EGG_MOVES_TUTOR))
    {
        for (i = 0; i < sizeof(eggMoveLearnset); i++)
        {
            ...
            if (j == MAX_MON_MOVES)
            {
                for (k = 0; k < numEggMoves && moves[k] != eggMoveLearnset[i]; k++)
                    ;

                if (k == numEggMoves)
                    moves[numEggMoves++] = eggMoveLearnset[i];
            }
        }
