...
const u8 gText_ThisIsAPokemon[] = _("…{PAUSE 96}This Pokémon is very round.{PAUSE 96}\p");
...
const u8 gText_PkmnForSwap[] = _("{PKMN} for Sswap");
...
const u8 gText_CannotSendMonToBoxHM[] = _("Cannot send that one to the box,\nbecause it knows a HM move.{PAUSE_UNTIL_PRESS}");
