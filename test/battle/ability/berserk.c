...
SINGLE_BATTLE_TEST("ABILITY: Berserk activates only if the target had more than 50% of its hp")
{
...
SINGLE_BATTLE_TEST("ABILITY: Berserk raises Sp.Atk by 1")
{
    u16 maxHp = 500;
    GIVEN {
        ASSUME(!IsBattleMoveStatus(MOVE_TACKLE));
...
SINGLE_BATTLE_TEST("ABILITY: Berserk activates after all hits from a multi-hit move")
{
    u32 j;
    u16 maxHp = 500;
    GIVEN {
