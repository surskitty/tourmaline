...
DOUBLE_BATTLE_TEST("ABILITY: Commander will activate once Dondozo switches in")
{
    GIVEN {
...
DOUBLE_BATTLE_TEST("ABILITY: Commander increases all stats by 2 stages once it is triggered")
{
    GIVEN {
        PLAYER(SPECIES_TATSUGIRI) { Ability(ABILITY_COMMANDER); }
        PLAYER(SPECIES_DONDOZO);
...
DOUBLE_BATTLE_TEST("ABILITY: Commander Tatsugiri avoids moves targetted towards it")
{
    GIVEN {
        PLAYER(SPECIES_TATSUGIRI) { Ability(ABILITY_COMMANDER); }
        PLAYER(SPECIES_DONDOZO);
...
DOUBLE_BATTLE_TEST("ABILITY: Commander Tatsugiri will still take residual damage from a field effect while inside Dondozo")
{
    GIVEN {
        PLAYER(SPECIES_TATSUGIRI) { Ability(ABILITY_COMMANDER); }
        PLAYER(SPECIES_DONDOZO);
...
DOUBLE_BATTLE_TEST("ABILITY: Commander Tatsugiri will still take poison damage if while inside Dondozo")
{
    GIVEN {
...
DOUBLE_BATTLE_TEST("ABILITY: Commander Tatsugiri still avoids moves even when the attacker has No Guard")
{
    GIVEN {
        PLAYER(SPECIES_TATSUGIRI) { Ability(ABILITY_COMMANDER); }
        PLAYER(SPECIES_DONDOZO);
...
DOUBLE_BATTLE_TEST("ABILITY: Commander cannot affect a Dondozo that was previously affected by Commander until it faints and revived")
{
    GIVEN {
        PLAYER(SPECIES_WOBBUFFET);
        PLAYER(SPECIES_DONDOZO);
...
DOUBLE_BATTLE_TEST("ABILITY: Commander prevents Whirlwind from working against Dondozo or Tatsugiri while it's active")
{
    GIVEN {
        PLAYER(SPECIES_TATSUGIRI) { Ability(ABILITY_COMMANDER); }
        PLAYER(SPECIES_DONDOZO);
...
DOUBLE_BATTLE_TEST("ABILITY: Commander prevents Red Card from working while Commander is active")
{
    GIVEN {
        PLAYER(SPECIES_TATSUGIRI) { Ability(ABILITY_COMMANDER); }
        PLAYER(SPECIES_DONDOZO);
...
DOUBLE_BATTLE_TEST("ABILITY: Commander Tatsugiri is not damaged by a double target move if Dondozo faints")
{
    GIVEN {
...
DOUBLE_BATTLE_TEST("ABILITY: Commander Tatsugiri takes no damage from multi-target damaging moves")
{
    GIVEN {
        PLAYER(SPECIES_WOBBUFFET);
        PLAYER(SPECIES_TATSUGIRI) { Ability(ABILITY_COMMANDER); }
...
DOUBLE_BATTLE_TEST("ABILITY: Commander doesn't prevent Transform from working on a Commander Tatsugiri")
{
    GIVEN {
        PLAYER(SPECIES_DONDOZO);
        PLAYER(SPECIES_TATSUGIRI) { Ability(ABILITY_COMMANDER); }
...
DOUBLE_BATTLE_TEST("ABILITY: Commander doesn't prevent Imposter from working on a Commander Tatsugiri")
{
    GIVEN {
        PLAYER(SPECIES_DONDOZO);
        PLAYER(SPECIES_TATSUGIRI) { Ability(ABILITY_COMMANDER); }
...
DOUBLE_BATTLE_TEST("ABILITY: Commander Tatsugiri is still affected by Perish Song while controlling Dondozo")
{
    GIVEN {
        PLAYER(SPECIES_DONDOZO);
        PLAYER(SPECIES_TATSUGIRI) { Ability(ABILITY_COMMANDER); }
...
DOUBLE_BATTLE_TEST("ABILITY: Commander Tatsugiri is still affected by Haze while controlling Dondozo")
{
    GIVEN {
        PLAYER(SPECIES_WOBBUFFET);
        PLAYER(SPECIES_TATSUGIRI) { Ability(ABILITY_COMMANDER); }
...
DOUBLE_BATTLE_TEST("ABILITY: Commander Attacker is kept (Dondozo Left Slot)")
{
    GIVEN {
        ASSUME(GetMoveTarget(MOVE_SURF) == MOVE_TARGET_FOES_AND_ALLY);
        PLAYER(SPECIES_WOBBUFFET);
...
DOUBLE_BATTLE_TEST("ABILITY: Commander Attacker is kept (Dondozo Right Slot)")
{
    GIVEN {
        ASSUME(GetMoveTarget(MOVE_SURF) == MOVE_TARGET_FOES_AND_ALLY);
        PLAYER(SPECIES_TATSUGIRI) { Ability(ABILITY_COMMANDER); }
...
DOUBLE_BATTLE_TEST("ABILITY: Commander Tatsugiri does not attack if Dondozo faints the same turn it's switched in")
{
    GIVEN {
        PLAYER(SPECIES_WOBBUFFET);
        PLAYER(SPECIES_TATSUGIRI) { Ability(ABILITY_COMMANDER); }
...
DOUBLE_BATTLE_TEST("ABILITY: Commander Tatsugiri does not get hit by Dragon Darts when a commanded Dondozo faints")
{
    GIVEN {
...
DOUBLE_BATTLE_TEST("ABILITY: Commander Tatsugiri does not get hit by Dragon Darts when commanding Dondozo")
{
...
DOUBLE_BATTLE_TEST("INNATE: Commander will activate once Dondozo switches in")
{
    GIVEN {
        PLAYER(SPECIES_WOBBUFFET);
...
DOUBLE_BATTLE_TEST("INNATE: Commander cannot affect a Dondozo that was previously affected by Commander until it faints and revived")
{
    GIVEN {
        PLAYER(SPECIES_WOBBUFFET);
        PLAYER(SPECIES_DONDOZO);
...
DOUBLE_BATTLE_TEST("INNATE: Commander Tatsugiri is not damaged by a double target move if Dondozo faints")
{
    GIVEN {
        ASSUME(GetMoveTarget(MOVE_SURF) == MOVE_TARGET_FOES_AND_ALLY);
        PLAYER(SPECIES_DONDOZO) { HP(1); };
...
DOUBLE_BATTLE_TEST("INNATE: Commander Tatsugiri takes no damage from multi-target damaging moves")
{
    GIVEN {
        PLAYER(SPECIES_WOBBUFFET);
        PLAYER(SPECIES_TATSUGIRI) { Ability(ABILITY_STORM_DRAIN); Innates(ABILITY_COMMANDER); }
...
DOUBLE_BATTLE_TEST("INNATE: Commander doesn't prevent Transform from working on a Commander Tatsugiri")
{
    GIVEN {
        PLAYER(SPECIES_DONDOZO);
        PLAYER(SPECIES_TATSUGIRI) { Ability(ABILITY_STORM_DRAIN); Innates(ABILITY_COMMANDER); }
...
DOUBLE_BATTLE_TEST("INNATE: Commander doesn't prevent Imposter from working on a Commander Tatsugiri")
{
    GIVEN {
        PLAYER(SPECIES_DONDOZO);
        PLAYER(SPECIES_TATSUGIRI) { Ability(ABILITY_STORM_DRAIN); Innates(ABILITY_COMMANDER); }
...
DOUBLE_BATTLE_TEST("INNATE: Commander Tatsugiri is still affected by Perish Song while controlling Dondozo")
{
    GIVEN {
        PLAYER(SPECIES_DONDOZO);
        PLAYER(SPECIES_TATSUGIRI) { Ability(ABILITY_STORM_DRAIN); Innates(ABILITY_COMMANDER); }
...
DOUBLE_BATTLE_TEST("INNATE: Commander Tatsugiri is still affected by Haze while controlling Dondozo")
{
    GIVEN {
        PLAYER(SPECIES_WOBBUFFET);
        PLAYER(SPECIES_TATSUGIRI) { Ability(ABILITY_STORM_DRAIN); Innates(ABILITY_COMMANDER); }
...
DOUBLE_BATTLE_TEST("INNATE: Commander Tatsugiri does not attack if Dondozo faints the same turn it's switched in")
{
    GIVEN {
        PLAYER(SPECIES_WOBBUFFET);
        PLAYER(SPECIES_TATSUGIRI) { Ability(ABILITY_STORM_DRAIN); Innates(ABILITY_COMMANDER); }
...
DOUBLE_BATTLE_TEST("INNATE: Commander Tatsugiri does not get hit by Dragon Darts when a commanded Dondozo faints")
{
    GIVEN {
        ASSUME(GetMoveEffect(MOVE_DRAGON_DARTS) == EFFECT_DRAGON_DARTS);
        PLAYER(SPECIES_WOBBUFFET);
...
DOUBLE_BATTLE_TEST("INNATE: Commander Tatsugiri does not get hit by Dragon Darts when commanding Dondozo")
{
    bool32 targetPlayerRight;
    PARAMETRIZE { targetPlayerRight = TRUE; }
    PARAMETRIZE { targetPlayerRight = FALSE; }
