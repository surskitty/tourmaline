...
SINGLE_BATTLE_TEST("ABILITY: Lightning Rod absorbs Electric-type moves and increases the Sp. Attack [Gen5+]")
{
    GIVEN {
...
DOUBLE_BATTLE_TEST("ABILITY: Lightning Rod forces single-target Electric-type moves to target the Pokémon with this Ability.")
{
    GIVEN {
        ASSUME(GetMoveType(MOVE_THUNDERBOLT) == TYPE_ELECTRIC);
        PLAYER(SPECIES_WOBBUFFET);
...
DOUBLE_BATTLE_TEST("ABILITY: Lightning Rod redirects an ally's attack")
{
    GIVEN {
        ASSUME(GetMoveType(MOVE_THUNDERBOLT) == TYPE_ELECTRIC);
        PLAYER(SPECIES_WOBBUFFET);
...
SINGLE_BATTLE_TEST("INNATE: Lightning Rod absorbs Electric-type moves and increases the Sp. Attack [Gen5+]")
{
    GIVEN {
        ASSUME(GetMoveType(MOVE_THUNDERBOLT) == TYPE_ELECTRIC);
        PLAYER(SPECIES_WOBBUFFET);
...
DOUBLE_BATTLE_TEST("INNATE: Lightning Rod forces single-target Electric-type moves to target the Pokémon with this Ability.")
{
    GIVEN {
        ASSUME(GetMoveType(MOVE_THUNDERBOLT) == TYPE_ELECTRIC);
        PLAYER(SPECIES_WOBBUFFET);
...
DOUBLE_BATTLE_TEST("INNATE: Lightning Rod redirects an ally's attack")
{
    GIVEN {
        ASSUME(GetMoveType(MOVE_THUNDERBOLT) == TYPE_ELECTRIC);
        PLAYER(SPECIES_WOBBUFFET);
