...
SINGLE_BATTLE_TEST("ABILITY: Magician does not get self-damage recoil after stealing Life Orb")
{
    GIVEN {
...
SINGLE_BATTLE_TEST("INNATE: Magician does not get self-damage recoil after stealing Life Orb")
{
    GIVEN {
        ASSUME(gItemsInfo[ITEM_LIFE_ORB].holdEffect == HOLD_EFFECT_LIFE_ORB);
        ASSUME(!IsBattleMoveStatus(MOVE_TACKLE));
