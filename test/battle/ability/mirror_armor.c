...
SINGLE_BATTLE_TEST("ABILITY: Mirror Armor lowers a stat of the attacking pokemon")
{
    u16 move, statId;
...
SINGLE_BATTLE_TEST("ABILITY: Mirror Armor triggers even if the attacking Pokemon also has Mirror Armor ability")
{
    GIVEN {
        PLAYER(SPECIES_CORVIKNIGHT) { Ability(ABILITY_MIRROR_ARMOR); }
...
SINGLE_BATTLE_TEST("ABILITY: Mirror Armor doesn't lower the stats of an attacking Pokemon with the Clear Body ability")
{
    GIVEN {
        PLAYER(SPECIES_CORVIKNIGHT) { Ability(ABILITY_MIRROR_ARMOR); }
...
SINGLE_BATTLE_TEST("ABILITY: Mirror Armor lowers the Attack of Pokemon with Intimidate")
{
    GIVEN {
        PLAYER(SPECIES_CORVIKNIGHT) { Ability(ABILITY_MIRROR_ARMOR); }
...
SINGLE_BATTLE_TEST("ABILITY: Mirror Armor doesn't lower the stats of an attacking Pokemon behind Substitute")
{
    KNOWN_FAILING;
    GIVEN {
        PLAYER(SPECIES_CORVIKNIGHT) { Ability(ABILITY_MIRROR_ARMOR); }
...
SINGLE_BATTLE_TEST("ABILITY: Mirror Armor raises the stat of an attacking Pokemon with Contrary")
{
    GIVEN {
        PLAYER(SPECIES_CORVIKNIGHT) {Ability(ABILITY_MIRROR_ARMOR);}
...
SINGLE_BATTLE_TEST("ABILITY: Mirror Armor doesn't lower the stat of the attacking Pokemon if it is already at -6")
{
    GIVEN {
        PLAYER(SPECIES_CORVIKNIGHT) {Ability(ABILITY_MIRROR_ARMOR);}
        OPPONENT(SPECIES_WYNAUT);
...
DOUBLE_BATTLE_TEST("ABILITY: Mirror Armor lowers Speed of the partner Pokemon after Court Change was used by the opponent after it set up Sticky Web")
{
    KNOWN_FAILING;
    GIVEN {
...
SINGLE_BATTLE_TEST("ABILITY: Mirror Armor reflects Tangling Hair speed drop")
{
    GIVEN {
...
SINGLE_BATTLE_TEST("INNATE: Mirror Armor lowers a stat of the attacking pokemon")
{
    u16 move, statId;
...
// Unsure whether this should or should not fail, as Showdown has conflicting information. Needs testing in gen8 games.
SINGLE_BATTLE_TEST("INNATE: Mirror Armor doesn't lower the stats of an attacking Pokemon behind Substitute")
{
    KNOWN_FAILING;
    GIVEN {
        PLAYER(SPECIES_CORVIKNIGHT) { Ability(ABILITY_PRESSURE); Innates(ABILITY_MIRROR_ARMOR); }
...
// This behaviour needs to be verified in the actual games. Currently it's written to follow Showdown's logic.
DOUBLE_BATTLE_TEST("INNATE: Mirror Armor lowers Speed of the partner Pokemon after Court Change was used by the opponent after it set up Sticky Web")
{
    KNOWN_FAILING;
    GIVEN {
        ASSUME(GetMoveEffect(MOVE_STICKY_WEB) == EFFECT_STICKY_WEB);
