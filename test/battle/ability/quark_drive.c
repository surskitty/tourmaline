...
SINGLE_BATTLE_TEST("ABILITY: Quark Drive boosts the highest stat")
{
    GIVEN {
...
SINGLE_BATTLE_TEST("ABILITY: Quark Drive boosts either Attack or Special Attack, not both")
{
    u16 species;
    u32 move;
    s16 damage[2];
...
SINGLE_BATTLE_TEST("ABILITY: Quark Drive ability pop up activates only once during the duration of electric terrain")
{
    u16 turns;
...
SINGLE_BATTLE_TEST("ABILITY: Quark Drive activates on switch-in")
{
    GIVEN {
...
SINGLE_BATTLE_TEST("ABILITY: Quark Drive activates on Electric Terrain even if not grounded")
{
    GIVEN {
...
SINGLE_BATTLE_TEST("ABILITY: Quark Drive boosts Attack 1st in case of a stat tie")
{
    GIVEN {
...
SINGLE_BATTLE_TEST("ABILITY: Quark Drive boosts Defense 2nd in case of a stat tie")
{
    GIVEN {
...
SINGLE_BATTLE_TEST("ABILITY: Quark Drive boosts Special Attack 3rd in case of a stat tie")
{
    GIVEN {
...
SINGLE_BATTLE_TEST("ABILITY: Quark Drive boosts Special Defense 4th in case of a stat tie")
{
    GIVEN {
...
SINGLE_BATTLE_TEST("ABILITY: Quark Drive activates in Electric Terrain before Booster Energy")
{
    GIVEN {
        PLAYER(SPECIES_WOBBUFFET);
...
SINGLE_BATTLE_TEST("ABILITY: Quark Drive doesn't activate for a transformed battler")
{
    GIVEN {
        PLAYER(SPECIES_WOBBUFFET);
        PLAYER(SPECIES_IRON_TREADS) { Ability(ABILITY_QUARK_DRIVE); Item(ITEM_BOOSTER_ENERGY); }
