...
SINGLE_BATTLE_TEST("INNATE: Transistor increases Electric-type attack / special attack", s16 damage)
{
    u32 move;
    u16 ability;
...
SINGLE_BATTLE_TEST("INNATE: Transistor is blocked by neutralizing gas", s16 damage)
{
    u16 ability;
    PARAMETRIZE { ability = ABILITY_NEUTRALIZING_GAS; }
    PARAMETRIZE { ability = ABILITY_LEVITATE; }
