...
SINGLE_BATTLE_TEST("ABILITY: Unnerve prevents opposing Pokémon from eating their own berries")
{
    u16 mon;
    u16 ability;
...
SINGLE_BATTLE_TEST("ABILITY: Unnerve doesn't prevent opposing Pokémon from using Natural Gift")
{
    u16 mon;
    u16 ability;
    PARAMETRIZE { mon = SPECIES_JOLTIK, ability = ABILITY_UNNERVE; }
...
SINGLE_BATTLE_TEST("ABILITY: Unnerve prints the correct string (player)")
{
    u16 mon;
    u16 ability;
    PARAMETRIZE { mon = SPECIES_JOLTIK, ability = ABILITY_UNNERVE; }
...
SINGLE_BATTLE_TEST("ABILITY: Unnerve prints the correct string (opponent)")
{
    u16 mon;
    u16 ability;
    PARAMETRIZE { mon = SPECIES_JOLTIK, ability = ABILITY_UNNERVE; }
...
// Remember to add a PARAMETRIZE for As One in the following tests:
SINGLE_BATTLE_TEST("INNATE: Unnerve prevents opposing Pokémon from eating their own berries")
{
    u16 mon;
    u16 ability;
    PARAMETRIZE { mon = SPECIES_JOLTIK, ability = ABILITY_UNNERVE; }
...
SINGLE_BATTLE_TEST("INNATE: Unnerve doesn't prevent opposing Pokémon from using Natural Gift")
{
    u16 mon;
    u16 ability;
    PARAMETRIZE { mon = SPECIES_JOLTIK, ability = ABILITY_UNNERVE; }
...
SINGLE_BATTLE_TEST("INNATE: Unnerve prints the correct string (player)")
{
    u16 mon;
    u16 ability;
    PARAMETRIZE { mon = SPECIES_JOLTIK, ability = ABILITY_UNNERVE; }
...
SINGLE_BATTLE_TEST("INNATE: Unnerve prints the correct string (opponent)")
{
    u16 mon;
    u16 ability;
    PARAMETRIZE { mon = SPECIES_JOLTIK, ability = ABILITY_UNNERVE; }
