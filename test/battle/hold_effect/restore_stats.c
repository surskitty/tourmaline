...
SINGLE_BATTLE_TEST("INNATE: White Herb restores stats after Attack was lowered by Intimidate in singles")
{
    GIVEN {
        PLAYER(SPECIES_WOBBUFFET) { Item(ITEM_WHITE_HERB); }
...
DOUBLE_BATTLE_TEST("INNATE: White Herb restores stats after Attack was lowered by Intimidate in doubles")
{
    GIVEN {
        OPPONENT(SPECIES_WOBBUFFET) { Item(ITEM_WHITE_HERB); }
        OPPONENT(SPECIES_WYNAUT) { Item(ITEM_WHITE_HERB); }
...
SINGLE_BATTLE_TEST("INNATE: White Herb restores stats after Attack was lowered by Intimidate while switching in")
{
    GIVEN {
        PLAYER(SPECIES_WOBBUFFET) { Item(ITEM_WHITE_HERB); }
        OPPONENT(SPECIES_WOBBUFFET);
...
SINGLE_BATTLE_TEST("INNATE: White Herb wont have time to activate if it is knocked off or stolen by Thief")
{
    u16 move;
...
SINGLE_BATTLE_TEST("INNATE: White Herb has correct interactions with Intimidate triggered Defiant and Competitive")
{
    u16 species;
    u16 ability;
