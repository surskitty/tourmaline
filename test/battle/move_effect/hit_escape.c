...
SINGLE_BATTLE_TEST("INNATE: Hit Escape: U-turn does not switch the user out if Wimp Out activates")
{
    GIVEN {
        PLAYER(SPECIES_WOBBUFFET);
        PLAYER(SPECIES_WYNAUT);
...
SINGLE_BATTLE_TEST("INNATE: Hit Escape: U-turn switches the user out if Wimp Out fails to activate")
{
    GIVEN {
        PLAYER(SPECIES_WOBBUFFET);
        PLAYER(SPECIES_WYNAUT);
...
SINGLE_BATTLE_TEST("INNATE: Hit Escape: U-turn switches the user out after Ice Face activates")
{
    GIVEN {
        ASSUME(GetMoveCategory(MOVE_U_TURN) == DAMAGE_CATEGORY_PHYSICAL);
        PLAYER(SPECIES_BEEDRILL);
